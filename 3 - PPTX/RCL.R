...
my <- my %>%
  ...
  ph_with(tabela_acumulado,
          location = ph_location(left = 0.39, top = 2,
                                 width=9,height=4))  %>%
  ...
  ph_with(block_list(fpar(ftext(glue('(Valores em milhões de R$)'),
          ...
          location = ph_location(left = 4, top = 1.5,
                                 width = 6.5,
                                 height = 0.3)) %>%
...
# primeiro bloco  
  ...
  location = ph_location(left = 0.39, top = 1, width = 3.14, 
...
location = ph_location(left = 4, top = 1, width = 3.14, 
                       height = 0.90, bg = cor1[2]))
